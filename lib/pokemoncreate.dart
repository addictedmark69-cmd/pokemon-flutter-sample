...
try{
//check if have duplicate name and 2 more type
// int typecount=0;

// for(int i=0; i<SharedData.allPokemons.length; i++){
//   if(SharedData.allPokemons[i].pokemontype == poketypeInfo){
//     typecount++;
//   }
// }
...
//         SnackBar(
//           content: Text("Found 2 Duplicated Pokemon Type"),
//           backgroundColor: const Color.fromARGB(255, 236, 76, 1),
//         ),
//       );
//   return;
// }
